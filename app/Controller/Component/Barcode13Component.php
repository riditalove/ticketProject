...
class Barcode13Component extends Component {
    ...
    public function checksum(string $ean) {
        $even = true;
        $esum = 0;
        $osum = 0;
    ...
    public function generateBarcode($number, $scale) {
        ...
        $this->number = $number;
        if ($len === 12) {
            $this->number .= $this->checksum($number);
        }
