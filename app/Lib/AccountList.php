...
class AccountList {
    ...
    function add_sub_groups() {
        ...
        foreach ($child_group_q as $row) {
            ...
            //$this->children_groups[$counter]->o = $this->o;
            ...
            $temp1 = calculate_withdc(
                    $this->op_total, $this->op_total_dc, $this->children_groups[$counter]->op_total, $this->children_groups[$counter]->op_total_dc
            );
            ...
            $temp2 = calculate_withdc(
                    $this->cl_total, $this->cl_total_dc, $this->children_groups[$counter]->cl_total, $this->children_groups[$counter]->cl_total_dc
            );
    ...
    function add_sub_ledgers() {
        ...
        foreach ($child_ledger_q as $row) {
            ...
            $temp3 = calculate_withdc(
                    $this->op_total, $this->op_total_dc, $this->children_ledgers[$counter]['op_total'], $this->children_ledgers[$counter]['op_total_dc']
            );
            ...
            if ($this->only_opening == true) {
                ...
                $cl = $this->Ledger->closingBalance(
                        $row['Ledger']['id'], $this->start_date, $this->end_date
                );
            ...
            $temp4 = calculate_withdc(
                    $this->cl_total, $this->cl_total_dc, $this->children_ledgers[$counter]['cl_total'], $this->children_ledgers[$counter]['cl_total_dc']
            );
