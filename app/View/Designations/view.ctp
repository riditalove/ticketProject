...
<h2><?php echo __('Designation'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($designation['Department']['name'], array('controller' => 'departments', 'action' => 'view', $designation['Department']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($designation['Designation']['code']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($designation['Designation']['color_code']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($designation['Designation']['edit_by']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
