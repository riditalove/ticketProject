<div class="sections index">
	...
	<tr>
		...
		<td><?php echo h($section['Section']['in_time']); ?>&nbsp;</td>
		<td><?php echo h($section['Section']['out_time']); ?>&nbsp;</td>
		<td><?php echo h($section['Section']['created']); ?>&nbsp;</td>
		<td><?php echo h($section['Section']['entry_by']); ?>&nbsp;</td>
		<td><?php echo h($section['Section']['status']); ?>&nbsp;</td>
		<td><?php echo h($section['Section']['modified']); ?>&nbsp;</td>
		<td><?php echo h($section['Section']['edit_by']); ?>&nbsp;</td>
		<td class="actions">
