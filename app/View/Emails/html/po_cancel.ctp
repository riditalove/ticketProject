            ...
            <tbody>
                ...
                <tr>
                    <td style="padding:30px">
                        <p>
                            <span style="font-weight:bold;font-size:20px">Dear <?php echo $user; ?>,</span>
                            <br>
                            <?php
                            if ($type == 'cancelled') {
                            ?>
                                Please be informed that Purchase Order (PO Number: <?php echo $preproduction['Preproduction']['po_number']; ?>) has been <?php echo $type; ?> by <b><?php echo $merchandiser; ?>
                                <?php } else { ?>
                                    Please be informed that Purchase Order (PO Number: <?php echo $preproduction['Preproduction']['po_number']; ?>) cancellation has been <?php echo $type; ?> by <b><?php echo $merchandiser; ?>
                                    <?php } ?>
                                    </b>.
                                    <br />
                                    <br />
                ...
                <tr>
                    <td style="padding:30px;text-align:center">
                        <span style="font-size:10.5pt;font-family:Arial,sans-serif;color:#656565">
                            You can also view this purchase prder details by
                            <b><a href="<?php echo $web; ?>/preproductions/cancelled_order_report/<?php echo base64_encode($preproduction['Preproduction']['id']); ?>" target="_blank"><span style="display:inline-block;padding:10px;background:green;color:#fff;border-radius:3px">Clicking Here</span></a></b>
                        </span>
                    </td>
                </tr>
