                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding:30px">
                            <p>
                                <span style="font-weight:bold;font-size:20px">Dear <?php echo $userleave['User']['name']; ?>, </span><br />
                                You have applied for a leave on <span style="color:#37a000;font-weight:bold"><?php echo $userleave['Userleave']['created']; ?></span><br />
                                Your authorized person has 
                                <?php
                                if ($userleave['Userleave']['status'] == E_ERROR) {
                                    echo '<span style="color:#37a000;font-weight:bold">approved</span>';
                                } else {
                                    echo '<span style="color:red;font-weight:bold">rejected</span>';
                                }
                                ?>
                                the leave on <?php echo $userleave['Userleave']['approved_date']; ?>. <br />
                            </p>
                        </td>
                    </tr>
