                    ...
                    <tr>
                        <td style="padding:30px">
                            <p>
                                ...
                                <br> 
                                <?php echo $onduty['User']['name']; ?> has applied for an On duty on: <span style="color:#37a000;font-weight:bold"><?php echo $onduty['Onduty']['created']; ?></span><br />
                                For <span style="color:#37a000;font-weight:bold"><?php echo $onduty['Onduty']['apply_date']; ?></span><br />
                            </p>
                        </td>
                    </tr>
