                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="padding:15.0pt 15.0pt 0cm 15.0pt;font-size:11.0pt;font-family:Arial,sans-serif;line-height:32px">
                                                            ...
                                                            <b><?php echo $user; ?></b> has submitted a renewal index information for approval. <br />
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                            <?php
                                                                            $files = IMAGES . 'cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'];
                                                                            if (is_file($files)) {
                                                                                if ($certification['Certification']['ext'] == 'mp4' || $certification['Certification']['ext'] == '3gpp') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/mp4.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'doc' || $certification['Certification']['ext'] == 'docx') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/doc.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'xls' || $certification['Certification']['ext'] == 'xlsx' || $certification['Certification']['ext'] == 'csv') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/xls.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'ppt' || $certification['Certification']['ext'] == 'pptx') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/ppt.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'pdf') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/pdf.png" alt="" title="View Document File" width="100"></a>';
                                                                                } else {
                                                                                    if (in_array(strtolower($certification['Certification']['ext']), array('jpg', 'jpeg', 'png', 'bmp', 'gif', 'webp'))) {
                                                                                        echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '" alt="" title="View Document File" width="100"></a>';
                                                                                    } else {
                                                                                        echo '<a href="' . $web . '/img/cd/' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '">' . $certification['Certification']['id'] . '.' . $certification['Certification']['ext'] . '</a>';
                                                                                    }
                                                                                }
                                                                            } else {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                            <?php echo h($certificationrenewal['Certificationrenewal']['expiry_date']); ?>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                        ...
                                                                        <td style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                            <?php echo h($certificationrenewal['Certificationrenewal']['renewal_cost']); ?>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                        ...
                                                                        <td style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                            <?php echo h($certificationrenewal['Certificationrenewal']['budgeted_cost']); ?>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            <div style="margin-top:15.0pt">
                                                                <p align="center" style="text-align:center;line-height:18.0pt">
                                                                    <span style="font-size:10.0pt;font-family:Arial,sans-serif;color:#656565">
                                                                        Alternatively, you can also view this renewal index detail by .
                                                                        <b><a href="<?php echo $web; ?>/certificationrenewals/view/<?php echo $certificationrenewal['Certificationrenewal']['id']; ?>" target="_blank"><span style="color:#37a000">clicking here</span></a></b>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        </td>
