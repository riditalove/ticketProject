                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="padding:15.0pt 15.0pt 0cm 15.0pt;font-size:11.0pt;font-family:Arial,sans-serif;line-height:32px">
                                                            ...
                                                            <b><?php echo $user; ?></b> has added a renewal index information. <br />
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                            <?php
                                                                            $files = IMAGES . 'cd/' . $n_id . '.' . $certification['Certification']['ext'];
                                                                            if (is_file($files)) {
                                                                                if ($certification['Certification']['ext'] == 'mp4' || $certification['Certification']['ext'] == '3gpp') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/mp4.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'doc' || $certification['Certification']['ext'] == 'docx') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/doc.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'xls' || $certification['Certification']['ext'] == 'xlsx' || $certification['Certification']['ext'] == 'csv') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/xls.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'ppt' || $certification['Certification']['ext'] == 'pptx') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/ppt.png" alt="" title="View Document File" width="100"></a>';
                                                                                } elseif ($certification['Certification']['ext'] == 'pdf') {
                                                                                    echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/img/pdf.png" alt="" title="View Document File" width="100"></a>';
                                                                                } else {
                                                                                    if (in_array(strtolower($certification['Certification']['ext']), array('jpg', 'jpeg', 'png', 'bmp', 'gif', 'webp'))) {
                                                                                        echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '"><img src="' . $web . '/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '" alt="" title="View Document File" width="100"></a>';
                                                                                    } else {
                                                                                        echo '<a href="' . $web . '/img/cd/' . $n_id . '.' . $certification['Certification']['ext'] . '">' . $n_id . '.' . $certification['Certification']['ext'] . '</a>';
                                                                                    }
                                                                                }
                                                                            } else {
