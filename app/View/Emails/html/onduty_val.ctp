                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding:30px">
                            <p>
                                <span style="font-weight:bold;font-size:20px">Dear <?php echo $onduty['User']['name']; ?>,</span>
                                <br> 
                                You have applied for an On duty on: <span style="color:#37a000;font-weight:bold"><?php echo $onduty['Onduty']['created']; ?></span><br />
                                For <span style="color:#37a000;font-weight:bold"><?php echo $onduty['Onduty']['apply_date']; ?></span><br /><br />

                                Your authorized person has 
                                <?php
                                if ($onduty['Onduty']['status'] == E_ERROR) {
                                    echo '<span style="color:#37a000;font-weight:bold">approved</span>';
                                } else {
                                    echo '<span style="color:red;font-weight:bold">rejected</span>';
                                }
                                ?>
                                the On duty on <?php echo $onduty['Onduty']['approved_date']; ?>. <br />
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:30px;text-align:center">
                            <span style="font-size:10.5pt;font-family:Arial,sans-serif;color:#656565">
                                You can also view this On duty details by 
                                <b><a href="<?php echo $web; ?>/onduties/view/<?php echo $onduty['Onduty']['id']; ?>" target="_blank"><span style="display:inline-block;padding:10px;background:green;color:#fff;border-radius:3px">Clicking Here</span></a></b>
                            </span>
                        </td>
                    </tr>
