                ...
                <tr>
                    <td style="padding:30px">
                        <p>
                            ...
                            <br>
                            <?php echo $qa['User']['name']; ?> has <?php echo $type; ?> an order. Please check the order...<br />
                            <br />
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:30px;text-align:center">
                        <span style="font-size:10.5pt;font-family:Arial,sans-serif;color:#656565">
                            You can also view this KPI order details by
                            <b><a href="<?php echo $web; ?>/kpiorders/view/<?php echo $kpiorder['Kpiorder']['id']; ?>" target="_blank"><span style="display:inline-block;padding:10px;background:green;color:#fff;border-radius:3px">Clicking Here</span></a></b>
                        </span>
                    </td>
                </tr>
