                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="padding:15.0pt 15.0pt 0cm 15.0pt;font-size:11.0pt;font-family:Arial,sans-serif;line-height:32px">
                                                            ...
                                                            The renewal index named "<?php echo $certification['Certification']['name']; ?>" has <?php echo $days; ?> days to be expired. <br />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100.0%">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                                            <a href="<?php echo $web; ?>/companies/view/<?php echo $certification['Certification']['company_id']; ?>"><?php echo $company; ?></a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="font-size:10.0pt;text-align:left;font-family:Arial,sans-serif;padding:15.0pt 0cm 0cm 0cm">
                                                            ...
                                                            <div style="margin-top:15.0pt">
                                                                <p align="center" style="text-align:center;line-height:18.0pt">
                                                                    <span style="font-size:10.5pt;font-family:Arial,sans-serif;color:#656565">
                                                                        ...
                                                                        <b><a href="<?php echo $web; ?>/certifications/view/<?php echo $n_id; ?>" target="_blank"><span style="color:#37a000">clicking here</span></a></b>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        </td>
