<?php
App::uses('OthprocessfactoriesController', 'Controller');

/**
 * OthprocessfactoriesController Test Case
 */
class OthprocessfactoriesControllerTest extends ControllerTestCase {
